...
<div class="grid grid-small">
  <div class="gc-12">
    <h2>
      {@html
        $language === 'en'
          ? 'We are the largest and most advanced laboratory dedicated to glycan analysis, <b>setting the standard</b> in high-throughput glycomics research. With the capacity for <b>over 50,000 glycan and glycoproteomic analyses</b> annually, our laboratory handles the majority of global glycan research.'
          : 'Mi smo najveći i najnapredniji laboratorij posvećen analizi glikana, <b>postavljajući standard</b> u istraživanju glikomike visokog kapaciteta. S kapacitetom za <b>više od 50.000 analiza glikana i glikoproteoma</b> godišnje, naš laboratorij provodi većinu svjetskih istraživanja glikana.'
      }
    </h2>
  </div>
