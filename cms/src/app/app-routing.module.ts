...
const routes: Routes = [
  {
    ...
    canActivate: [AngularFireAuthGuard, HasClaimGuard],
    data: {
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        './modules/trigger-password-reset/trigger-password-reset.module'
  ...
  },
  {
    path: 'mfa',
    loadChildren: () =>
      import('./modules/mfa/mfa.module').then(m => m.MfaModule)
  },
  {
    path: '**',
