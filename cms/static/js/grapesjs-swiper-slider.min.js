  ...
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : 'object' == typeof exports
        ? (exports['grapesjs-swiper-slider'] = t(require('grapesjs')))
        : (e['grapesjs-swiper-slider'] = t(e.grapesjs));
})(window, function (r) {
  return (function (r) {
    var a = {};
    function n(e) {
    ...
    function (e, t, r) {
      ...
      var a = r(0),
        n = r.n(a),
        o = 'swiper-',
        i = ''.concat(o, 'container'),
        l = ''.concat(o, 'wrapper'),
        s = ''.concat(o, 'slide'),
        c = ''.concat(o, 'prev'),
        p = ''.concat(o, 'next'),
        d = ''.concat(o, 'pagination'),
        u = ''.concat(o, 'scrollbar'),
        g = {
          containerName: i,
          wrapperName: l,
          slideName: s,
          ...
          paginationName: d,
          scrollbarName: u,
          containerSelector: '[data-'.concat(i, ']'),
          wrapperSelector: '[data-'.concat(l, ']'),
          slideSelector: '[data-'.concat(s, ']'),
          prevSelector: '[data-'.concat(c, ']'),
          nextSelector: '[data-'.concat(p, ']'),
          paginationSelector: '[data-'.concat(d, ']'),
          scrollbarSelector: '[data-'.concat(u, ']'),
          containerId: 'data-'.concat(i),
          wrapperId: 'data-'.concat(l),
          slideId: 'data-'.concat(s),
          prevId: 'data-'.concat(c),
          nextId: 'data-'.concat(p),
          paginationId: 'data-'.concat(d),
          scrollbarId: 'data-'.concat(u)
        };
      var f = function (e) {
          var r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            u = g.prevSelector,
            f = g.nextSelector,
            b = g.paginationSelector,
            m = g.scrollbarSelector,
            y = g.containerId;
          e.addType(o, {
            model: a.extend(
              {
                defaults: (function (n) {
                  ...
                  a.prototype.defaults,
                  {
                    ...
                    autoplay: !0,
                    autoplayDelay: 3e3,
                    autoplayStopOnLastSlide: !1,
                    autoplayDisableOnInteraction: !0,
                    autoplayReverseDirection: !1,
                    autoplayWaitForTransition: !0,
                    ...
                    traits: [
                      ...
                      { type: 'number', label: 'Speed', name: 'speed', changeProp: 1 },
                      {
                        type: 'number',
                      ...
                      { type: 'checkbox', label: 'Auto Height', name: 'autoHeight', changeProp: 1 },
                      {
                        type: 'checkbox',
                      ...
                      { type: 'checkbox', label: 'Scrollbar', name: 'scrollbar', changeProp: 1 },
                      {
                        type: 'select',
                        label: 'Pagination',
                        name: 'pagination',
                    ...
                    'script-deps': r.script,
                    'style-deps': r.style,
                    'class-container': r.classContainer,
                    'class-wrapper': r.classWrapper,
                    'class-prev': r.classPrev,
                    'class-next': r.classNext,
                    'class-pagination': r.classPagination,
                    'class-scrollbar': r.classScrollbar,
                    script: function () {
                      var e = this,
                        t = '{[ script-deps ]}',
                        r = e.getAttribute('id'),
                        a = {
                          ...
                          loop: isNaN('{[ loop ]}'),
                          navigation: {
                            nextEl: '#'.concat(r, ' .swiper-button-next'),
                            prevEl: '#'.concat(r, ' .swiper-button-prev')
                          },
                      ...
                      ['0', 'false', 'none'].includes('{[ pagination ]}') ||
                        (a.pagination = {
                          el: '#'.concat(r, ' .swiper-pagination'),
                          type: '{[ pagination ]}'
                        }),
                        ['1', 'true'].includes('{[ autoplay ]}') &&
                          (a.autoplay = {
                            delay: '{[ autoplayDelay ]}',
                      ...
                      if ('undefined' == typeof Swiper) {
                        ...
                        (i.src = t), (i.onload = n), document.head.appendChild(i);
                      } else n();
                    }
                  },
                  r.sliderProps
              ...
              },
              {
                isComponent: function (e) {
                  if (e.hasAttribute && e.hasAttribute(y)) return { type: o };
                }
              }
            ),
            view: n.extend({
        ...
        b = function (e, t) {
          var r = e.className;
          if ((r = r && r.toString()) && 0 <= r.split(' ').indexOf(t)) return 1;
        };
      var m = function (e) {
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                {},
                a.prototype.defaults,
                { name: 'Wrapper', droppable: o, draggable: i },
                t.wrapperProps
              ),
              init: function () {
            ...
            {
              isComponent: function (e) {
                if (b(e, t.classWrapper)) return { type: n };
              }
            }
          ),
          view: r.view.extend({
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                return n;
              })({}, a.prototype.defaults, { name: 'Slide', draggable: i }, t.slideProps)
            },
            {
              isComponent: function (e) {
                if (b(e, t.classSlide)) return { type: o };
              }
            }
          ),
          view: n
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                {},
                a.prototype.defaults,
                { name: 'Nav Previous', copyable: 0, draggable: o },
                t.prevProps
              ),
              init: function () {
                this.get('classes').pluck('name').indexOf(i) < 0 && this.addClass(i);
              }
            },
            {
              isComponent: function (e) {
                if (b(e, i)) return { type: l };
              }
            }
          ),
          view: r.view
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                {},
                a.prototype.defaults,
                { name: 'Nav Next', copyable: 0, draggable: o },
                t.nextProps
              ),
              init: function () {
                this.get('classes').pluck('name').indexOf(i) < 0 && this.addClass(i);
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                {},
                a.prototype.defaults,
                { name: 'Pagination', copyable: 0, draggable: o },
                t.paginationProps
              ),
              init: function () {
                this.get('classes').pluck('name').indexOf(i) < 0 && this.addClass(i);
          ...
          model: a.extend(
            {
              defaults: (function (n) {
                ...
                {},
                a.prototype.defaults,
                { name: 'Scrollbar', copyable: 0, draggable: o },
                t.scrollbarProps
              ),
              init: function () {
                this.get('classes').pluck('name').indexOf(i) < 0 && this.addClass(i);
      ...
      t.default = n.a.plugins.add('grapesjs-swiper-slider', function (e) {
        var t = (function (n) {
          for (var e = 1; e < arguments.length; e++) {
            var o = null != arguments[e] ? arguments[e] : {},
              t = Object.keys(o);
        ...
        !(function (e) {
          var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
            r = e.DomComponents;
          f(r, t), m(r, t), y(r, t), v(r, t), w(r, t), P(r, t), S(r, t);
        })(e, t),
          h(e, t);
      });
    }
