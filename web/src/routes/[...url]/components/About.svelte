        ...
        <p class="text-p">
          {@html
            $language === 'en'
              ...
              : 'Uz naš rad u glikomici, Genos ima bogatu povijest u analizi DNA. Osnovan 2007. godine, Genosov DNA i forenzički laboratorij bio je prvi privatni DNA laboratorij u regiji i i dalje je vodeći u testiranju ljudske i životinjske genetike u Hrvatskoj.<br><br>Sve DNA analize provodimo interno u našem laboratoriju u Zagrebu koristeći najsuvremeniju opremu za precizne i pouzdane rezultate. Genos je dio međunarodno certificiranog sustava kontrole kvalitete GEDNAP (njemačko profiliranje DNA), čime se osiguravaju najviši standardi u forenzičkoj DNA analizi. Kao prvi privatni laboratorij u Hrvatskoj ovlašten za forenzičku DNA analizu, naši su stručnjaci pridonijeli nacionalnim identifikacijskim naporima, uključujući program identifikacije žrtava nakon rata.<br><br>Za razliku od tvrtki koje testiranja prepuštaju vanjskim partnerima, Genos sve analize provodi interno, zadržavajući potpunu kontrolu nad kvalitetom i točnošću.'
          }
        </p>
      </div>
    </div>
