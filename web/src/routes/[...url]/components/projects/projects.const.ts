export const PROJECTS = [
  {
    ...
    projects: [
      ...
      {
        short: 'Public consultation – Report (ESMP)',
        titleEn: 'Public Consultation – Report',
        descriptionEn: 'Based on the conducted public consultation procedure and the fact that no comments were received, it is determined that the drafts of the subject ESMP checklists remain unchanged.',
        titleHr: 'Javno savjetovanje – izvješće',
        descriptionHr: 'Na temelju provedenog postupka javnog savjetovanja i činjenice da nisu zaprimljeni komentari, utvrđuje se da nacrti predmetnih ESMP checklista ostaju u neizmijenjenom obliku.',
        startDate: '13/01/2026',
        projectDurationInDays: '',
        pdf: 'report-on-the-conducted-public-consultation.pdf',
        projectId: 'P180755',
        callForProposals: 'DIGIT.2.2.01',
        coordinator: 'Genos d.o.o.',
        projectParticipants: 2,
      ...
      {
        short: 'GRM (ESMP)',
        titleEn: 'Grievance Redress Mechanism (GRM)',
        descriptionEn: 'A Grievance Redress Mechanism (GRM) is established by publishing the email address grmdigit@genos.hr in accordance with the conducted public consultation and ESMP checklists, to which the interested public, whether groups or individuals, can send complaints, comments, and/or suggestions regarding the implementation of projects under the authority of DIGIT.',
        titleHr: 'GRM mehanizam',
        descriptionHr: 'Uspostavlja se Mehanizam za rješavanje pritužbi (GRM) objavom mail adrese grmdigit@genos.hr sukladno provedenom javnom savjetovanju i ESMP checklistama na koju zainteresirana javnost, bilo grupe ili pojedinci, mogu slati pritužbe, komentare i/ili prijedloge na provedbu projekata u nadležnosti DIGIT-a.',
        startDate: '13/01/2026',
        coordinator: 'Genos d.o.o.',
        projectParticipants: 2,
      },
  ...
  },
  {
    ...
    projects: [
      ...
      {
        short: 'ZCI',
        titleEn: 'Cutting-edge research in centers of excellence',
    ...
    projects: [
      {
        ...
        descriptionHr: 'Ovaj projekt usmjeren je na razvoj personaliziranih testova za procjenu biološke starosti mozga i omogućavanje ranog otkrivanja demencije. Cilj je stvoriti inovativne dijagnostičke alate koji mogu pomoći u identifikaciji ranih biomarkera demencije, čime se poboljšavaju ishodi za pacijente kroz ranu intervenciju. Projekt uključuje partnerstvo između različitih institucija, a Genos je jedan od ključnih projektnih partnera koji doprinosi istraživanju i razvoju personaliziranih zdravstvenih rješenja.',
  ...
  },
  {
    ...
    projects: [
      ...
      {
        short: 'GlycoBioM',
        titleEn: 'Tools for the Detection of Novel Glyco-biomarkers',
        descriptionEn: 'Glycosylation is a post-translational modification that enriches protein complexity and function. Dysregulation of glycosylation is associated with a wide range of diseases, including cancer, diabetes, as well as congenital, cardiovascular, immunological and infectious disorders. A number of studies identified potentially important glycan disease biomarkers. With regard to biotechnology, proper glycosylation of biologicals is important, as deviations in glycosylation are known to be associated with adverse drug reactions and reduced therapeutic efficacy. However, glycomics is significantly lagging behind genomics and proteomics, mainly due to the absence of high-throughput analytical methods which can reliably quantify a multitude of glycan structures in complex biological samples.<br><br>We are confident that by coordinated efforts of leading European scientists in glycan analysis using HPLC, MS and CGE-LIF technologies this project will make a decisive step forward by developing real high-throughput tools for glycosylation analysis. By teaming up with leading European researchers in the field of genome wide association studies this project will perform validation of all methods on extremely well characterized set of samples resulting from the FP6 EuroSpan project. The addition of the newly generated glycome data to the pre-existing information about these individuals will enable development of methods for the systems biology approach analysis of the glycome which will integrate glycomic, genomic and environmental data about thousands of individuals. The same methods will also be adapted for quality control and monitoring in the production of biopharmaceuticals.<br><br>Strong participation of SMEs in the project and close contacts with large industrial partners will ensure that research accomplishments achieved by collaboration between academic and industrial scientists are swiftly transformed into innovative products and services for the benefit of European industry.',
        titleHr: 'Alati za otkrivanje novih gliko-biomarkera',
    ...
    programs: [
      ...
      },
      {
        ...
        projects: [
          ...
          {
            shortEn: 'Analysis of Antenary Fucose as Routine Diagnostics for HNF1A-MODY',
            descriptionEn: 'The project focuses on analyzing antennary fucose as a potential routine diagnostic tool for HNF1A-MODY, a genetic form of diabetes. By examining specific glycosylation patterns, such as the presence of antennary fucose on plasma proteins, the project aims to develop a reliable diagnostic method for identifying this condition.<br><br>The project is co-financed by BICRO (the Croatian Agency for SMEs, Innovation, and Investments) as part of the Innovative Concept Verification Program.<br><br>The goal of the project is to validate the feasibility of using antennary fucose as a diagnostic marker, ultimately contributing to more accessible and accurate diagnostics for patients with HNF1A-MODY.',
            shortHr: 'Analiza antenarnog fukoza za rutinsku dijagnostiku HNF1A-MODY dijabetesa',
            descriptionHr: 'Projekt se fokusira na analizu antenarnog fukoza kao potencijalnog rutinskog dijagnostičkog alata za HNF1A-MODY, genetski oblik dijabetesa. Ispitivanjem specifičnih obrazaca glikozilacije, poput prisutnosti antenarnog fukoza na plazmatskim proteinima, cilj je razviti pouzdanu dijagnostičku metodu za prepoznavanje ovog stanja.<br><br>Projekt je sufinanciran od strane BICRO-a (Hrvatska agencija za malo gospodarstvo, inovacije i investicije) u sklopu Programa provjere inovativnog koncepta.<br><br>Cilj projekta je potvrditi izvedivost korištenja antenarnog fukoza kao dijagnostičkog markera te time doprinijeti pristupačnijoj i preciznijoj dijagnostici za pacijente s HNF1A-MODY dijabetesom.',
      ...
      },
      {
        ...
        projects: [
          {
            shortEn: 'Antenary Fucosylation of Plasma Proteins as a Biomarker for HNF1A-MODY',
      ...
      },
      {
        ...
        projects: [
          {
            shortEn: 'High-Throughput Plasma Glycan Analysis',
            descriptionEn: 'The project aimed to develop and optimize high-throughput analytical methods for plasma glycan profiling. By leveraging advanced glycomics technologies, the research focused on improving the efficiency and accuracy of glycan analysis, enabling large-scale studies on the role of glycans in health and disease. The findings contributed to the broader application of glycomics in biomarker discovery and personalized medicine.',
            shortHr: 'Visokoprotočna analiza glikana u plazmi',
            descriptionHr: 'Projekt je imao za cilj razvoj i optimizaciju visokoprotočnih analitičkih metoda za profiliranje glikana u plazmi. Korištenjem naprednih glikomičkih tehnologija, istraživanje se fokusiralo na poboljšanje učinkovitosti i točnosti analize glikana, omogućujući provedbu velikih studija o ulozi glikana u zdravlju i bolesti. Rezultati su pridonijeli široj primjeni glikomike u otkrivanju biomarkera i personaliziranoj medicini.',
      ...
      },
      {
        ...
        projects: [
          {
            shortEn: 'Analysis of N-Linked Glycans in Human Plasma',
            descriptionEn: 'The project focused on the comprehensive analysis of N-linked glycans in human plasma to better understand their role in health and disease. By employing advanced glycomics techniques, researchers aimed to identify glycan biomarkers that could contribute to improved diagnostics and personalized medicine. The study provided valuable insights into the structural complexity of glycans and their potential as indicators of various physiological and pathological conditions.',
            shortHr: 'Analiza N-vezanih glikana u ljudskoj plazmi',
            descriptionHr: 'Projekt se fokusirao na sveobuhvatnu analizu N-vezanih glikana u ljudskoj plazmi s ciljem boljeg razumijevanja njihove uloge u zdravlju i bolesti. Primjenom naprednih glikomičkih tehnika, istraživači su nastojali identificirati glikanske biomarkere koji bi mogli doprinijeti poboljšanju dijagnostike i personalizirane medicine. Studija je pružila vrijedne uvide u strukturnu složenost glikana i njihov potencijal kao pokazatelja različitih fizioloških i patoloških stanja.',
      ...
      },
      {
        ...
        projects: [
          {
            shortEn: 'Application of DNA Analysis in the Development of Traceability Systems in Livestock and Meat Processing Production',
            descriptionEn: 'The project focused on applying DNA analysis to develop advanced traceability systems for the livestock and meat processing industries. By implementing genetic identification methods, the project aimed to enhance food safety, quality control, and regulatory compliance. The outcomes provided a reliable framework for tracking the origin of meat products, ensuring authenticity, and reducing the risk of fraud in the supply chain.',
            shortHr: 'Primjena DNA analize u razvoju sustava sljedivosti u stočarskoj i mesoprerađivačkoj proizvodnji',
            descriptionHr: 'Projekt se fokusirao na primjenu DNA analize za razvoj naprednih sustava sljedivosti u stočarskoj i mesoprerađivačkoj industriji. Uvođenjem metoda genetske identifikacije, cilj je bio poboljšati sigurnost hrane, kontrolu kvalitete i usklađenost s propisima. Rezultati su omogućili pouzdan okvir za praćenje podrijetla mesnih proizvoda, osiguranje autentičnosti i smanjenje rizika od prijevara u opskrbnom lancu.',
