            ...
            <div class="project-card-container">
              <div class="project-card">
                ...
                <button
                  ...
                  on:click={() => (selectedProject = selectedProject === project ? '' : project)}
                >
                  {#if $language === 'en'}
                ...
                {#if selectedProject === project}
                  <div class="project-details" transition:slide>
                    {#if selectedProject.descriptionEn || selectedProject.descriptionHr}
                      <p style="margin-bottom: 1rem;">
                        {#if $language === 'en'}
                          {@html selectedProject.descriptionEn}
                        {:else}
                          {@html selectedProject.descriptionHr}
                        {/if}
                      </p>
                    {/if}
                    <table>
                      <tbody>
                        ...
                        {#if selectedProject.projectDuration}
                          <tr>
                            <td
                              >{@html $language === 'en'
                                ? 'Project Duration:'
                                : 'Trajanje projekta:'}</td
                            >
                            <td
                              >{selectedProject.projectDuration}
                              {@html $language === 'en' ? 'months' : 'mjeseci'}</td
                            >
                          </tr>
                        {/if}
                        ...
                        {#if selectedProject.euCoFinancingAmount}
                          <tr>
                            <td
                              >{@html $language === 'en'
                                ? 'Eu Co-finacing Amount:'
                                : 'Iznos EU sufinanciranja:'}</td
                            >
                        ...
                        {#if selectedProject.contactPerson}
                          <tr>
                            <td
                              >{@html $language === 'en' ? 'Contact Person:' : 'Kontakt osoba:'}</td
                            >
                ...
                <div class="project-card-container">
                  <div class="project-card">
                        ...
                        <table>
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  {#if selectedProject.projectDurationInDays}
                                    {selectedProject.projectDurationInDays}
                                    {@html $language === 'en' ? 'days' : 'dana'}
                                  {:else}
                                    {selectedProject.projectDuration}
                                    {@html $language === 'en' ? 'months' : 'mjeseci'}
                                  {/if}
                                </td>
                              </tr>
                            {/if}
                            ...
                            {#if selectedProject.callForProposals}
                              <tr>
                                <td
                                  >{@html $language === 'en' ? 'Call For Proposals:' : 'Poziv:'}</td
                                >
                                <td>{selectedProject.callForProposals}</td>
                              </tr>
                            {/if}
                            ...
                            {#if selectedProject.projectLead}
                              <tr>
                                <td
                                  >{@html $language === 'en'
                                    ? 'Project lead'
                                    : 'Voditelj projekta:'}</td
                                >
                                <td>
                                  {#if $language === 'hr'}{selectedProject.jobTitle?.hr}{/if}
                                  {selectedProject.projectLead}{#if $language === 'en'}{selectedProject
                                      .jobTitle?.en}{/if}
                                </td>
                              </tr>
                            {/if}
                    ...
                    {#if project.pdf}
                      {#if $language === 'en'}
                        <a
                          href="/pdfs/en/{project.pdf}"
                          target="_blank"
                          class="button-filled open-pdf"
                        >
                          Open as PDF
                        </a>
                      {:else}
                        <a
                          href="/pdfs/hr/{project.pdf}"
                          target="_blank"
                          class="button-filled open-pdf"
                        >
                          Otvori kao PDF
