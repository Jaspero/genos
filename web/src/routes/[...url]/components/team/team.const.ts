export const TEAM = [
  ...
  {
    name: 'Dr. sc. Nina Šimunić Briški',
  ...
  {
    name: 'Dr. sc. Natali Nakić Bedeković',
  ...
  {
    name: 'Dr. sc. Irena Trbojević Akmačić',
    job: 'Lead Researcher',
    img: 'akmacic',
  ...
  {
    name: 'Dr. sc. Marina Martinić Kavur',
    job: 'Senior Researcher',
    img: 'kavur',
  ...
  {
    name: 'Dr. sc. Vedrana Vičić Bočkor',
    job: 'Senior Researcher',
    img: 'bockor',
