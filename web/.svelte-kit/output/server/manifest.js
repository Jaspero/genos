...
return {
	...
	_: {
		...
		routes: [
			...
			{
				id: "/my-account/plasmid-orders",
				pattern: /^\/my-account\/plasmid-orders\/?$/,
				params: [],
			...
			{
				id: "/tools/plasmid-builder",
				pattern: /^\/tools\/plasmid-builder\/?$/,
				params: [],
